...
namespace SAV_Backend.Services
{
    public class ArticleService : IArticleService
    {
        ...
        public async Task<Article?> CreateArticle(ArticleCreateModel model)
        {
            if (model == null)
            {
                return null;
            ...
            try
            {
                ...
                {
                    // Id is not set here because it's auto-generated by the database
                ...
                return article; // Return the created article with the assigned Id
            }
            catch (Exception ex)
            {
                // Log the exception
